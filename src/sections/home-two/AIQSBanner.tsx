...
import sliderImg from '../../../public/assets/images/ai.png';
                                ...
                                <div className="container">
                                    <div className="main-slider__content">
                                        <div className="main-slider__title-box">
                                            <h2 className="main-slider__title">Quantity Surveying +<br /><span> Artificial Intelligence</span></h2>

                                        </div>
                                        <p className="main-slider__text">
                                            You will be an AI Powered Quantity Surveyors<br/> once you complete these modules Future-Ready QS Skills Start Here</p>
