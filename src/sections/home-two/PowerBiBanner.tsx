...
import sliderImg from '../../../public/assets/images/powerbi.png';
                                ...
                                <div className="container">
                                    <div className="main-slider__content">
                                        <div className="main-slider__title-box">
                                            <h2 className="main-slider__title">Power BI for Quantity Surveyors &<br /><span> Construction Professionals</span></h2>

                                        </div>
                                        <p className="main-slider__text">
                                            The only Power BI course built specifically for the construction industry. <br/>Master dashboards, BOQ analysis, cost tracking and procurement<br/> reporting using real industry data.</p>
