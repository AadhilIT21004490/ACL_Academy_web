                ...
                <div className="main-menu-two__top-inner">
                    ...
                    <div className="main-menu-two__top-right">
                        ...
                        <div className="main-menu-two__social">
                            <a href="https://wa.me/+94763136718" target='_blank'><i className="fab fa-whatsapp"></i></a>
                            <a href="https://web.facebook.com/people/ACL-Academy/61581348707450/" target='_blank'><i className="fab fa-facebook"></i></a>
                            <a href="https://www.linkedin.com/company/acl-academy1/" target='_blank'><i className="fab fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
            </div>
