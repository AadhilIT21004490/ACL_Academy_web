...
const MobileNav: React.FC = () => {
    const { isMobile, setIsMobile, activeSection } = useFinrisContext();
            ...
            <div className="mobile-nav__content" style={{ width: '300px' }}>
                ...
                <ul className="mobile-nav__contact list-unstyled">
                    ...
                    <li>
                        ...
                        <Link href="tel:+94763136718">+94763136718</Link>
                    </li>
                </ul>
            ...
            <div className="mobile-nav__content" style={{ width: '300px' }}>
                ...
                <div className="mobile-nav__container">
                    <ul className="main-menu__list">
                        ...
                        <li><Link onClick={closeMobileState} href="/inner/blog">Latest Updates</Link></li>
