...
export const courses: BlogPost[] = [
  {
    ...
    title: `Quantity Surveying Practice Classes`,
    description:
      "Master the art of quantity surveying with our practical courses. Gain hands-on experience in cost management, project delivery, and commercial processes based on real projects.",
  ...
  },
  {
    ...
    title: "RICS APC Mock Interviews",
    description:
      "Prepare for RICS APC interview with our comprehensive coaching classes. providing you with the knowledge and skills needed to succeed in your professional journey.",
  ...
  },
  {
    ...
    date: "July 10, 2025",
    tags: ["Ai", "★", "Ai Agents"],
    title: "Quantity Surveying + Artificial Intelligence Classes",
    description:
...
export const blogPosts: BlogPost[] = [
  {
    ...
    description:
      "As we move towards 2025, the landscape of artificial intelligence continues to evolve",
  ...
  },
  {
    ...
    description:
      "Achieving a healthier lifestyle doesn't have to be complicated.",
    link: "/inner/blog-details",
  },
  {
    id: 3,
    ...
    description:
      "This guide covers sustainable fabrics, ethical brands, and mindful shopping",
    link: "/inner/blog-details",
  },
  {
    id: 4,
    ...
    description:
      "Automation is reshaping industries by improving efficiency and reducing costs.",
    link: "/inner/blog-details",
  },
];
...
export const blogs: BlogPage[] = [
  {
    ...
    title: "Future of Artificial Intelligence: What's Next in 2025?",
    description:
      "We move towards 2025, the landscape of artificial intelligence.",
    link: "/inner/blog-details",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Learn how to adjust your campaigns effectively to maintain visibility.",
    link: "/inner/blog-details",
  },
  {
    id: 5,
    ...
    description:
      "This blog provides insights into addressing diverse audience needs.",
    link: "/inner/blog-details",
  },
  {
    id: 6,
    ...
    description:
      "This post offers practical advice on balancing cost constraints.",
    link: "/inner/blog-details",
  },
  {
    id: 7,
    ...
    tags: ["Productivity", "★", "Tech Innovation"],
    title:
      "The Importance of Accurate Performance Reporting in Digital Marketing",
    description:
      "Find out how to track key metrics effectively and use data for improvements.",
    link: "/inner/blog-details",
  },
  {
    id: 8,
